        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
            I am passionate and innovative full-stack developer with a strong foundation in cyber security. With over 4 years of experience, he has honed his skills in creating dynamic and responsive web applications using technologies like React, Node.js, and Tailwind CSS. Dhanushkumar is dedicated to continuous learning and staying updated with the latest industry trends, making him a valuable asset in any development team. His commitment to excellence and problem-solving abilities have earned him recognition in the tech community, and he is always eager to take on new challenges and contribute to impactful projects.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1hPp1m4QNpuKndynVkkIMmzyULgIqY0LX/view?usp=drive_link" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
